...
export default {
  ...
  methods: {
    ...
    setFormValues ({...vehicle}) {
      ...
      let fields = ['vehicleNo', 'vehicleNumber', 'vehicleColor', 'name', 'engineNo', 'useType', 'brand', 'vehicleType', 'phone', 'merchantId', 'factoryDate', 'operationState', 'emissionStandard', 'fuelType', 'content', 'staffId', 'seatNum']
      let obj = {}
