            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-select v-model="queryParams.status" allowClear>
                  <a-select-option value="1">接单中</a-select-option>
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case 1:
              return <a-tag color="green">接单中</a-tag>
            case 2:
              return <a-tag color="red">离开</a-tag>
            default:
              return '- -'
          }
        }
