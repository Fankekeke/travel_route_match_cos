...
import vehicleAdd from './RouteStaffAdd.vue'
import vehicleEdit from './RouteStaffEdit.vue'
import vehicleView from './RouteStaffView.vue'
...
export default {
  ...
  methods: {
    ...
    editStatus (row, status) {
      this.$post('/business/route-staff-info/account/status', { vehicleId: row.id, status }).then((r) => {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/route-staff-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/route-staff-info/page', {
        ...params
      }).then((r) => {
